...
static bool lex_match(Parser* parser, int type)
{
...
{
    int op_type = parser->lex->prev.type;
...
static void expr_grouping(Parser* parser, bool assign)
{
    ...
    int curr = parser->lex->curr.type;
    int next = parser->lex->next.type;
